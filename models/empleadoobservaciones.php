  ...
  if($sth->rowCount() < 1){
    ...
    while($data = $sth->fetch(PDO::FETCH_ASSOC)) {
      $parse = $parse.'<tr>
                        ...
                        <td>'.$data['detalle'].'</td>
                        <td><div class="td-actions"><a href="./index.php?acc=empleados&ver='.$data['id_observacion_empleado'].'" class="icon green" data-toggle="tooltip" data-placement="top" title="Modificar"><i class="icon-save"></i></a><a href="#" class="icon blue" data-toggle="tooltip" data-placement="top" title="Dar de Baja"><i class="icon-circle-with-minus"></i></a><a href="#" class="icon red" data-toggle="tooltip" data-placement="top" title="Eliminar"><i class="icon-cancel"></i></a></div></td></tr>';
    } 
    echo $parse;
  }
}
