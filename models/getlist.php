		...
		'id_empresa' ,  'razon_social' 'cuit' 'correo_electronico' 'domicilio' 'telefono' 'fecha_inicio_actividad' 'id_localidad' 'id_rama_empresa' 'id_usuario_sistema' 'fecha_alta' 'fecha_baja' 'flg_baja'*/
			while($row = $query->fetch(PDO::FETCH_ASSOC)) {
				$parse = $parse.'<tr>
								  ...
								  <td><div class="td-actions"><a href="javascript:void(0);" onClick="verObservacion(\''.$row['razon_social'].'\');" class="icon red" data-toggle="tooltip" data-placement="top" title="Ver Observaciones"><i class="icon-bell"></i></a><a href="#" class="icon red" data-toggle="tooltip" data-placement="top" title="Agregar Empleado"><i class="icon-user-plus"></i></a><a href="./?acc=empresasficha&id='.$row['id_empresa'].'" class="icon green" data-toggle="tooltip" data-placement="top" title="Ver/Modificar"><i class="icon-save"></i></a><a href="#" class="icon blue" data-toggle="tooltip" data-placement="top" title="Dar de Baja"><i class="icon-circle-with-minus"></i></a><a href="#" class="icon red" data-toggle="tooltip" data-placement="top" title="Eliminar"><i class="icon-cancel"></i></a></div></td></tr>';
		    }
