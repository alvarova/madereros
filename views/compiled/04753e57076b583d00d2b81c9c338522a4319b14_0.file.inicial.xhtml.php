<?php
/* Smarty version 3.1.36, created on 2020-06-21 13:21:09
  from 'C:\xampp\htdocs\madereros\views\inicial.xhtml' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_5eef42a5d440b3_29679532',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '04753e57076b583d00d2b81c9c338522a4319b14' => 
    array (
      0 => 'C:\\xampp\\htdocs\\madereros\\views\\inicial.xhtml',
      1 => 1592738468,
      2 => 'file',
    ),
  ),
...
function content_5eef42a5d440b3_29679532 (Smarty_Internal_Template $_smarty_tpl) {
?>
					<!-- Row starts -->
					<div class="row gutters">
								...
								<div class="card-body">
									<div class="agenda">
										<div class="todays-date">
											<h5>Agenda - Proximos<span class="date" id="todays-date"></span></h5>
										</div>
						...
						<div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
							<div class="card h-320">
								<div class="card-header">
									<div class="card-title">Empresas - pendientes</div>
								</div>
								<div class="card-body">
										...
										<ul class="user-messages">
											<li class="clearfix">
												...
												<div class="delivery-details">
													...
													<h5>Aaleyah Malik</h5>
													<p>We are pleased to inform that the following ticket no. <b>SOEIM510</b> have been booked.</p>
												</div>
											</li>
											<li class="clearfix">
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
							<div class="card h-320">
								<div class="card-header">
									<div class="card-title">Afiliados - Solicitudes (<a href='#'>ver todas</a>)</div>
								</div>
								<div class="card-body">
									<div class="customScroll5">
										<div class="top-agents-container">
											<div class="top-agent">
												<img src="assets/img/user.png" class="avatar" alt="Agent" />
												<div class="agent-details">
													...
													<div class="agent-score">
														...
														<div class="points">
															<div class="left">Martin Fierro</div>
															<div class="right">7 dias</div>
														</div>
													</div>
												</div>
											</div>
											<div class="top-agent">
												<img src="assets/img/user22.png" class="avatar" alt="Agent" />
												<div class="agent-details">
													<h6>Lily Jordan</h6>
													<div class="agent-score">
														<div class="progress">
														...
														<div class="points">
															<div class="left">Vuelta al mundo en 7 dias</div>
															<div class="right">5 dias</div>
														</div>
													</div>
												</div>
											</div>
											<div class="top-agent">
												<img src="assets/img/user6.png" class="avatar" alt="Agent" />
												<div class="agent-details">
													<h6>Ali Sayed</h6>
													<div class="agent-score">
														<div class="progress">
														...
														<div class="points">
															<div class="left">El Quijote</div>
															<div class="right">3 dias</div>
														</div>
													</div>
												</div>
											</div>
											<div class="top-agent">
												<img src="assets/img/user20.png" class="avatar" alt="Agent" />
												<div class="agent-details">
													<h6>Aaleyah Malik</h6>
													<div class="agent-score">
														<div class="progress">
											...
											<div class="top-agent">
												<img src="assets/img/user13.png" class="avatar" alt="Agent" />
												<div class="agent-details">
													<h6>Aabid Raheem</h6>
													<div class="agent-score">
														<div class="progress">
